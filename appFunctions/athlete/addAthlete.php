...
if(isset($_POST['aid'])) 
		...
		$query = "insert into athlete (fname, lname, position, academic_level, street_current, city_current, state_current, zip_current, street_hometown, city_hometown, state_hometown, zip_hometown, phone, team_id) values ('$fname', '$lname', '$position', '$al', '$strc', '$cc', '$sc', '$zc', '$strh', '$ch', '$sh', '$zh', '$phone', '$tid')";
